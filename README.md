...
A full-stack TypeScript application that transforms text content into AI-powered summaries. Built with Express.js backend, Remix frontend, and GitHub Models integration.
